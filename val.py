...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/yolov5_dataset.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/wood_surface_inspection.pt', help='model.pt path(s)')
